...
public class Oauth2Controller {
	...
	public Result getAccessToken(
			...
			@RequestParam(value = Oauth2Constant.PASSWORD, required = false) String password) throws Exception {
